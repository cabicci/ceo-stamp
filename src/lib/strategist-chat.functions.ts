...
2) تتكلم كاستراتيجي سينيور: بتشرح "ليه" الزاوية دي مناسبة في جملة أو اتنين.
3) تستخدم نفس قاموس الأطر المعروفة بس: Cialdini (Scarcity / Urgency / Social Proof)، Eugene Schwartz (Awareness Stages)، Byron Sharp (Mental Availability / Distinctive Assets)، StoryBrand (Brand as Guide)، AIDA، PAS.
...
{"phase":"plan","message":"<شرح قصير بالعربي ليه الخطة دي مناسبة، 2-4 جمل>","plan":{
  ...
  "frameworks":["<framework names from approved vocabulary>"],
...
- لو بتنصح بباكدچ، خلي package_id يساوي id الباكدچ، واتبع نفس الأطر بتاعته كأساس.
  ...
  .handler(async ({ data, context }) => {
    ...
    if (proposed.length === 0) {
      ...
      finalPlan = {
        ...
        frameworks: Array.isArray(aiResult.plan.frameworks) ? aiResult.plan.frameworks : [],
