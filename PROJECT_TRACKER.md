...
| 2026-07-04 | **Bidi POC V4 on `/poc-arabic-image`** — resvg 2.6.2 ignores LRI/PDI and `unicode-bidi`; added `reorderForRtl()` (manual run reversal for mixed Arabic+Latin, no-op on pure Arabic) as V4 alongside failed V1–V3; production burn unchanged. |
