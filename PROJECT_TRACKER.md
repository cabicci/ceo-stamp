...
| 2026-07-05 | **Bidi POC: bidi-js** — replaced manual `reorderForRtl` with `bidi-js` UAX#9 (`visualPaintStringForRtl`: token sort by reordered indices, `direction=ltr` for resvg); 4 test lines on `/poc-arabic-image`; production burn unchanged. |
