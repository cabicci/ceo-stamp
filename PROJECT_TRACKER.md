...
| 2026-07-05 | **Bidi POC V4 fix** — `reorderForRtl` run reversal is correct for resvg LTR paint; mixed hooks must use `direction="ltr"` (RTL direction re-reversed Arabic). Added embedded-Latin test `ابدأ مع masaarat دلوقتي`; production burn unchanged. |
